...
public class AtomicNamespacePropImpl extends ASTWrapperPsiElement implements AtomicNamespaceProp {

  public AtomicNamespacePropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitNamespaceProp(this);
  }
