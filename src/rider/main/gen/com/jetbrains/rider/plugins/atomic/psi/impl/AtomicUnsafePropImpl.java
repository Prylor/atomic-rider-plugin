...
public class AtomicUnsafePropImpl extends ASTWrapperPsiElement implements AtomicUnsafeProp {

  public AtomicUnsafePropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitUnsafeProp(this);
  }
