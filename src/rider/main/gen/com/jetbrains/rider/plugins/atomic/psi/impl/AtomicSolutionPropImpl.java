...
public class AtomicSolutionPropImpl extends ASTWrapperPsiElement implements AtomicSolutionProp {

  public AtomicSolutionPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitSolutionProp(this);
  }
