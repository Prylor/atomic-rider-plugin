...
public class AtomicEntityTypePropImpl extends ASTWrapperPsiElement implements AtomicEntityTypeProp {

  public AtomicEntityTypePropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitEntityTypeProp(this);
  }
