...
public class AtomicHeaderPropImpl extends ASTWrapperPsiElement implements AtomicHeaderProp {

  public AtomicHeaderPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitHeaderProp(this);
  }
