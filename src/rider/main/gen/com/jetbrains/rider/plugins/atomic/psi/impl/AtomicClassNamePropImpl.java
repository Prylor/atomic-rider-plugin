...
public class AtomicClassNamePropImpl extends ASTWrapperPsiElement implements AtomicClassNameProp {

  public AtomicClassNamePropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitClassNameProp(this);
  }
