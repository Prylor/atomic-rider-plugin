...
public class AtomicDirectoryPropImpl extends ASTWrapperPsiElement implements AtomicDirectoryProp {

  public AtomicDirectoryPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AtomicVisitor visitor) {
    visitor.visitDirectoryProp(this);
  }
