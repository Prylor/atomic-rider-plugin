...
class RemoveImportToResolveAmbiguityQuickFix(
    private val namespace: String,
    private val typeName: String
) : IntentionAction {
    
    override fun getText(): String = "Remove import '$namespace' to resolve ambiguity"
    
    override fun getFamilyName(): String = "Remove import to resolve ambiguity"
